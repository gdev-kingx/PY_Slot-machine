...
def get_SM_spin(rows, cols, symbols):
    all_symbols = []
...
def spin(balance):
    ...
    slots = get_SM_spin(ROWS, COLS, symbol_ct)
    print_SM(slots)
    winnings, winning_lines = check_winnings(slots, lines, bet, symbol_val)
